...
export default function BedsheetsPage() {
  ...
  {/* SINGLE SECTION */}
  <h3 id="single-bedsheets"  className="scroll-mt-[90px] font-semibold mt-16 font-playfair text-2xl md:text-3xl tracking-wide"
        style={{ color: "#9a4d2e" }} >Single Bedsheets</h3>
  ...
  <h3 id="double-queen" className="scroll-mt-[90px] font-semibold mt-16 font-playfair text-2xl md:text-3xl tracking-wide"
        style={{ color: "#9a4d2e" }}>Double Bedsheets (Queen)</h3>
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-10 mt-8 place-items-center">
  ...
  {/* DOUBLE KING SECTION */}
  <h3 id="double-king" className="scroll-mt-[90px] font-semibold mt-16 font-playfair text-2xl md:text-3xl tracking-wide"
        style={{ color: "#9a4d2e" }}>Double Bedsheets (King)</h3>
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-10 mt-8 place-items-center">
  ...
  {/* DUVET SINGLE */}
  <h3 id="duvets" className="scroll-mt-[90px] font-semibold mt-16 font-playfair text-2xl md:text-3xl tracking-wide"
        style={{ color: "#9a4d2e" }}>Duvet Covers</h3>
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-10 mt-8 place-items-center">
  ...
  <h3 id="pillow-covers" className="scroll-mt-[90px] font-semibold mt-16 font-playfair text-2xl md:text-3xl tracking-wide"
        style={{ color: "#9a4d2e" }}>Pillow Covers </h3>
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-10 mt-8 place-items-center">
